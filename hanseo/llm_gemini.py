"""
특수 문자 비율(special_char_threshold)로 필터링한 noisy data를 
LLM(gemini 1.5 flash)를 통해서 cleaning 하는 코드입니다.
API_KEY, INPUT_FILE을 수정한 뒤 사용하면 됩니다.
"""
### SETTING ###
API_KEY=''
INPUT_FILE='noisy_data.csv'
###############
...
prompt_template = PromptTemplate(
    ...
    다음은 노이즈가 포함된 텍스트입니다:
    "{noisy_text}"
    이 텍스트의 의미를 유지하면서 노이즈를 제거하고, 뉴스 제목 형태로 자연스럽고 간결하게 변환해주세요.
    """
)
